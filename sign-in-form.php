...
<body>
    ...
    <div class="Form">
        <form name="myform" method="post" action="sign-in-form.php" onsubmit = "return validateForm();">   
            <pre>UserID:   <input type="text" name="userid" required placeholder="required and must of length 5 and 12"></pre>
            <pre>Password:<input type="password" name="password" required placeholder="required and must of length 7 and 12"><br></pre>
        ...
        if(isset($_POST['submit']))
        {
            ...
            $sql="select userid,pwd from user where userid='$userid' AND pwd='$password';";
